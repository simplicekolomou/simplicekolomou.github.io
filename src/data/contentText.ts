/**
 * Fichier de contenu textuel pour le portfolio de Simplice Kolomou.
...
export const text = {
    ...
    contact: {
        ...
        email: {
            title: "Email",
            mail: "simplicekolomou@gmail.com",
            description:
    ...
    footer: {
        ...
        copyright:
            `© ${new Date().getFullYear()} Simplice Kolomou. Tous droits réservés.`,
